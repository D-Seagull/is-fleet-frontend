...
import { ArrowLeft, Send, Search, Plus, Bell, Download, Calendar, User } from "lucide-react"
                  ...
                  {filteredTrips.map((trip) => {
                    ...
                    return (
                      <TableRow key={trip.id}>
                        <TableCell className="font-medium">TRIP-{trip.id.padStart(3, "0")}</TableCell>
                              ...
                              <div className="flex flex-col gap-4 py-4">
                                <div className="grid grid-cols-2 gap-4">
                                  <div className="flex flex-col gap-1">
                                    <span className="text-xs font-medium text-muted-foreground uppercase">Truck</span>
                                    <div className="flex items-center gap-2">
                                  ...
                                  <div className="flex flex-col gap-1">
                                    ...
                                    <div className="flex items-center gap-2">
                                      <Avatar className="h-8 w-8">
                                        <AvatarImage src={tripDriver?.avatarUrl} />
                                        <AvatarFallback className="bg-primary/10 text-primary">
                                          {tripDriver?.name.charAt(0) || "?"}
                                        </AvatarFallback>
                                      </Avatar>
                                      <span className="font-medium">{tripDriver?.name || "Unassigned"}</span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                  ...
                                  <div>
                                    ...
                                    <p className="font-medium">{trip.endDate || "In Progress"}</p>
                                  </div>
                                </div>
                              </div>
                            </DialogContent>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span className="font-medium">{currentDriver.rating}/5</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
