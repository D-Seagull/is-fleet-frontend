...
import { Search, Download, Calendar as CalendarIcon, ChevronLeft, ChevronRight } from "lucide-react"
...
export default function DocumentsPage() {
  ...
  const filteredDocuments = documents.filter((doc) => {
    ...
    const matchesDate = !selectedDate || doc.uploadDate === selectedDate.toISOString().split("T")[0]
    return matchesSearch && matchesTruck && matchesTrip && matchesDate
  })

  const uniqueTrucks = [...new Set(documents.map((d) => d.truckId))].map((id) => {
